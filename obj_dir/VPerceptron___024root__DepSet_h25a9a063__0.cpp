...
void VPerceptron___024root___eval_triggers__act(VPerceptron___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __Vtrigprevexpr_h6a988f12__0;
    __Vtrigprevexpr_h6a988f12__0 = 0;
    // Body
    __Vtrigprevexpr_h6a988f12__0 = (1U & (~ (IData)(vlSelfRef.BenchPerceptronIntroduction__DOT__training)));
    ...
    vlSelfRef.__VactTriggered.setBit(2U, ((IData)(__Vtrigprevexpr_h6a988f12__0) 
                                          != (IData)(vlSelfRef.__Vtrigprevexpr_h6a988f12__1)));
    vlSelfRef.__Vtrigprevexpr___TOP__BenchPerceptronIntroduction__DOT__clk__0 
        = vlSelfRef.BenchPerceptronIntroduction__DOT__clk;
    vlSelfRef.__Vtrigprevexpr_h6a988f12__1 = __Vtrigprevexpr_h6a988f12__0;
